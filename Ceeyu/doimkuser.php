...
<head>
    ...
    <title>ChangePass-Doancs2</title>
...
?>
    ...
    <?php include 'xulydoimkusser.php';  ?>
    <div id="mess">
...
<script>
  ...
  function myfuncmess(){
    ...
    <p style="text-align: center;margin-top:100px;font-size: 22px;font-family: 'Times New Roman', Times, serif;"><a id='backkk'onclick="history.back()"><i class='fa-solid fa-chevron-left'></i></a>Hồ sơ của tôi &nbsp > &nbsp Đổi mật khẩu</p>
 ...
 <br>
 <div id="divpas2">
<form method="POST" onsubmit="return matchpass()"name="f1"  acction="doimkuser.php" class='classpas'>
<?php
   include 'connection.php';
   ...
   <input type='submit' class="buttondoimkuser" name="thaydoiuser" value='THAY ĐỔI' /> 
...
let chucai=/[a-z]/;
let chuso=/\d/;
if(firstpassword &&secondpassword&&password2){
...
return false;  
  ...
  document.getElementById("passnew").style.borderColor="red";
    document.getElementById("checkcc").innerHTML = "Không được để trống";
    
    document.getElementById("password2").style.borderColor="red";
    document.getElementById("check").innerHTML = "Không được để trống";

    document.getElementById("mkhientai").style.borderColor="red";
    document.getElementById("checkmk").innerHTML = "Không được để trống";
  return false;
}
}
