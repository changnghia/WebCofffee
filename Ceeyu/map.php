...
<body>
    ...
    <div id="header">
        ...
        <ul id="menu">
        <li><a href="" style="color: rgb(83, 117, 101);">VỊ TRÍ</a></li>    
...
<script>
  ...
  function myfuncmess(){
    ...
    <p style="text-align: center;margin-top:100px;font-size: 15px;font-family: 'Times New Roman', Times, serif;">TRANG CHỦ > VỊ TRÍ</p>
 <hr style="width:700px;"/>
 <div style='text-align:center'>
 <br>
 <h1 style="color:black;font-family: 'Times New Roman', Times, serif;">TÌM QUÁN CÀ PHÊ</h1>

 <iframe src="https://www.google.com/maps/d/embed?mid=1maySKHijkTNH0kEkIxoaaSHYGONnHW0&ehbc=2E312F" width="1040" style="border:none" height="580"></iframe>
</div>
<br><br>
