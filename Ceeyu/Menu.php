...
<body>
    ...
    <div id="header">
        ...
        <li><a href="index.php">TRANG CHỦ</a></li>
            <li id="hovermenuplus"><a href="" style="color: rgb(83, 117, 101);">THỰC ĐƠN</a>
            <ul id="menuplus">
              <?php 
...
<script>
  ...
  function myfuncmess(){
    document.getElementById("loinhan").classList.toggle("show");
      ...
      <input name="tukhoa" id="tukhoainput"type="text" placeholder="Nhập từ khóa...">
    ...
    <p style="text-align: center;margin-top:40px;font-size: 15px;font-family: 'Times New Roman', Times, serif;">THỰC ĐƠN > <?php require 'connection.php';
...
$sql = "SELECT * FROM sanpham where loaisp='$tdm'";
$result = $conn->query($sql);
...
$conn->close();
  ...
  echo "          <p style='color:red'>eror: Không nhận đuược tên danh mục</p>";
}
