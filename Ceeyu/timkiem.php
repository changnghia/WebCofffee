...
<body>
    ...
    <div id="header">
        ...
        <li><a href="index.php">TRANG CHỦ</a></li>
            <li id="hovermenuplus"><a href="Menu.php?action=menu&dm=Cà phê Phin giấy" style="color: rgb(83, 117, 101);">THỰC ĐƠN</a>
            <ul id="menuplus">
              <?php 
...
echo "  <p id='avt'><img src='http://localhost/CEEYU/image/".$_SESSION['avt']."'   width='25px' ></p> <b id='tentk' >" .$_SESSION['ten'] . "
  ...
  <li><a href='donhang.php'>Đơn mua</a></li>
  <li><a href='login/logout.php?return_url=".$current_url."'>Đăng Xuất</a></li>
  </ul>
</b>  ";
}
...
<div style="text-align:center;margin-top:80px" >
      ...
      <input name="tukhoa" id="tukhoainput"type="text" placeholder="Nhập từ khóa..." onkeyup="searchfunc()">
        <input type="submit" name="tutim" id="tutim" value="Tìm">
        <label for="tutim" id="labeltim"> <i class="fa-solid fa-magnifying-glass"></i> Tìm</label>
        </form>
      </div>


    <p style="text-align: center;margin-top:40px;font-size: 15px;font-family: 'Times New Roman', Times, serif;">THỰC ĐƠN </p>

    <hr style="width:700px;"/>
    
    
<table style="margin-left:190px;margin-top:40px;">
...
$tukhoa=$_POST['tukhoa'];
    ...
    echo " <p style='text-align:center'>Từ khóa ''<span style='color:red'id='spntim'>$tukhoa</span>''</p>";
...
if ($result->num_rows > 0) {
    ...
    while($row = $result->fetch_assoc()) {
        ...
        <td id='muc1'>
               ...
               <img style='padding-left:23px;width:200px;height:250px;' src='image/".$row["image"]."'><br>
              
           <p id='tensp'>     
           <a href='Chitiet.php?action=hienthi&id=".$row['id']."'>". $row["tensp"] . "</a>
               </p>
            <p id='gia'>  Giá: ". $row["gia"] ." VNĐ </p>
            
            <form  method='GET' action='xulycard.php'>
            <input type='hidden' name='action' value='add'/>
            <input type='hidden' name='id' value='". $row['id']."'/>
            <input type='hidden' name='return_url' value='".$current_url."' />
            <input id='buttonadd' type='submit' value='ADD TO CARD'/>
          </form>
           </td>
              ";     
...
$conn->close();
  ...
  echo "          <p style='color:red'>eror: Từ khóa không hợp lệ</p>";
}
...
?>
 ...
 <p style="margin-top: -45px;margin-left:0px;"><li><i>Email:</i></li> </p>
    ...
    <a href="https://twitter.com/sontungmtp777" target="_blank"><i id="twit" class="fa-brands fa-twitter" style="font-size:30px;"></i></a>
     ...
     <script>
     function searchfunc(){
  let tim=document.querySelector('#tukhoainput');
  let view=Array.from(document.querySelectorAll('#muc1'));
  var tukhoa=document.querySelector('#tukhoainput').value;
      document.getElementById("spntim").innerHTML=tukhoa;
  //ẩn hiện
